...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('ilove')
		.setDescription('How much do you love someone')
	...
	async execute(interaction) {
		...
		const embed = new Discord.MessageEmbed()
			.setColor('RANDOM')
			.setTitle(`How much does ${interaction.user.username} love ${person}?`)
			.setDescription(`${interaction.user} loves **${person}** this much:\n\n**${Math.floor(love)}%\n${loveLevel}**`)
